...
# ==== Manual Tampering ====
st.markdown("<h4 style='color:#333;'>🛠️ Tamper Metadata</h4>", unsafe_allow_html=True)
...
st.markdown("<h3 style='color:#333;'>🔗 Blockchain Status Across Servers</h3>", unsafe_allow_html=True)
